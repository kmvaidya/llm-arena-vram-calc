...
| 2 | qwen3.5-397b-a17b | 1450 | 397 (17) | MoE | 992.5 | 496.2 | 248.1 | Multi-GPU |
| 3 | kimi-k2.5-thinking | 1450 | 1000 (32) | MoE | 2500 | 1250 | 625 | Multi-GPU |
| 4 | glm-4.7 | 1440 | 357 (32) | MoE | 892.5 | 446.2 | 223.1 | Multi-GPU |
| 5 | kimi-k2.5-instant | 1435 | 1000 (32) | MoE | 2500 | 1250 | 625 | Multi-GPU |
...
| 20 | mistral-large-3 | 1415 | 675 (41) | MoE | 1687.5 | 843.8 | 421.9 | Multi-GPU |
...
| 25 | longcat-flash-chat | 1399 | 560 (27) | MoE | 1400 | 700 | 350 | Multi-GPU |
| 26 | minimax-m2.5 | 1399 | 230 (10) | MoE | 575 | 287.5 | 143.8 | B300 SXM (FP8) |
...
| 29 | qwen3-vl-235b-a22b-thinking | 1394 | 235 (22) | MoE | 587.5 | 293.8 | 146.9 | Multi-GPU |
| 30 | deepseek-v3-0324 | 1394 | 671 (37) | MoE | 1677.5 | 838.8 | 419.4 | Multi-GPU |
| 31 | step-3.5-flash | 1390 | ? | ? | ? | ? | ? | ? |
| 32 | mimo-v2-flash (non-thinking) | 1389 | 309 (15) | MoE | 772.5 | 386.2 | 193.1 | Multi-GPU |
...
| 43 | gemma-3-27b-it | 1365 | 27.4 | Dense | 68.5 | 34.2 | 17.1 | H100 SXM (FP8) |
| 44 | glm-4.7-flash | 1364 | 31.2 (3) | MoE | 78 | 39 | 19.5 | H100 SXM (FP8) |
...
| 48 | gpt-oss-120b | 1354 | 117 (5.1) | MoE | 292.5 | 146.2 | 73.1 | B200 SXM (FP8) |
...
| 52 | minimax-m2 | 1347 | 230 (10) | MoE | 575 | 287.5 | 143.8 | B300 SXM (FP8) |
| 53 | qwen3-32b | 1347 | 32.8 | Dense | 82 | 41 | 20.5 | H100 SXM (FP8) |
...
| 73 | nvidia-nemotron-3-nano-30b-a3b-bf16 | 1316 | 31.6 (3.6) | MoE | 79 | 39.5 | 19.8 | H100 SXM (FP8) |
...
| 76 | deepseek-v2.5 | 1307 | 236 (21) | MoE | 590 | 295 | 147.5 | Multi-GPU |
| 77 | athene-70b-0725 | 1306 | 70 | Dense | 175 | 87.5 | 43.8 | RTX PRO 6000 (FP8) |
...
| 94 | llama-3-70b-instruct | 1276 | 70 | Dense | 175 | 87.5 | 43.8 | RTX PRO 6000 (FP8) |
...
| 100 | command-r-plus | 1262 | 104 | Dense | 260 | 130 | 65 | H200 SXM (FP8) |
| 101 | qwen2-72b-instruct | 1261 | 72 | Dense | 180 | 90 | 45 | RTX PRO 6000 (FP8) |
| 102 | phi-4 | 1256 | 14 | Dense | 35 | 17.5 | 8.8 | H100 SXM (FP8) |
| 103 | olmo-2-0325-32b-instruct | 1252 | 32 | Dense | 80 | 40 | 20 | H100 SXM (FP8) |
| 104 | command-r-08-2024 | 1250 | 35 | Dense | 87.5 | 43.8 | 21.9 | H100 SXM (FP8) |
| 105 | jamba-1.5-mini | 1239 | 52 (12) | MoE | 130 | 65 | 32.5 | H100 SXM (FP8) |
| 106 | ministral-8b-2410 | 1237 | 8 | Dense | 20 | 10 | 5 | H100 SXM (FP8) |
| 107 | qwen1.5-110b-chat | 1234 | 110 | Dense | 275 | 137.5 | 68.8 | H200 SXM (FP8) |
...
| 110 | command-r | 1227 | 35 | Dense | 87.5 | 43.8 | 21.9 | H100 SXM (FP8) |
...
| 118 | qwen1.5-32b-chat | 1204 | 32 | Dense | 80 | 40 | 20 | H100 SXM (FP8) |
| 119 | gemma-2-2b-it | 1198 | 2 | Dense | 5 | 2.5 | 1.2 | H100 SXM (FP8) |
| 120 | phi-3-medium-4k-instruct | 1198 | 14 | Dense | 35 | 17.5 | 8.8 | H100 SXM (FP8) |
| 121 | mixtral-8x7b-instruct-v0.1 | 1197 | 46.7 (12.9) | MoE | 116.8 | 58.4 | 29.2 | H100 SXM (FP8) |
| 122 | dbrx-instruct-preview | 1195 | 132 (36) | MoE | 330 | 165 | 82.5 | B200 SXM (FP8) |
...
| 130 | granite-3.0-8b-instruct | 1182 | 8 | Dense | 20 | 10 | 5 | H100 SXM (FP8) |
...
| 144 | granite-3.0-2b-instruct | 1156 | 2 | Dense | 5 | 2.5 | 1.2 | H100 SXM (FP8) |
...
| 147 | dolphin-2.2.1-mistral-7b | 1152 | 7 | Dense | 17.5 | 8.8 | 4.4 | H100 SXM (FP8) |
...
| 151 | falcon-180b-chat | 1147 | 180 | Dense | 450 | 225 | 112.5 | B300 SXM (FP8) |
| 152 | qwen1.5-7b-chat | 1144 | 7 | Dense | 17.5 | 8.8 | 4.4 | H100 SXM (FP8) |
| 153 | phi-3-mini-4k-instruct-june-2024 | 1143 | 3.8 | Dense | 9.5 | 4.8 | 2.4 | H100 SXM (FP8) |
| 154 | llama-2-13b-chat | 1141 | 13 | Dense | 32.5 | 16.2 | 8.1 | H100 SXM (FP8) |
| 155 | vicuna-13b | 1141 | 13 | Dense | 32.5 | 16.2 | 8.1 | H100 SXM (FP8) |
...
| 158 | gemma-7b-it | 1136 | 7 | Dense | 17.5 | 8.8 | 4.4 | H100 SXM (FP8) |
...
| 163 | zephyr-7b-alpha | 1127 | 7 | Dense | 17.5 | 8.8 | 4.4 | H100 SXM (FP8) |
| 164 | stripedhyena-nous-7b | 1121 | 7 | Dense | 17.5 | 8.8 | 4.4 | H100 SXM (FP8) |
| 165 | codellama-70b-instruct | 1119 | 70 | Dense | 175 | 87.5 | 43.8 | RTX PRO 6000 (FP8) |
...
| 177 | gpt4all-13b-snoozy | 1066 | 13 | Dense | 32.5 | 16.2 | 8.1 | H100 SXM (FP8) |
| 178 | mpt-7b-chat | 1061 | 7 | Dense | 17.5 | 8.8 | 4.4 | H100 SXM (FP8) |
| 179 | chatglm3-6b | 1056 | 6 | Dense | 15 | 7.5 | 3.8 | H100 SXM (FP8) |
...
| 185 | dolly-v2-12b | 980 | 12 | Dense | 30 | 15 | 7.5 | H100 SXM (FP8) |
