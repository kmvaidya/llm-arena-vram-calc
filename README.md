...
> **Last updated:** 2026-03-19 06:51 UTC | **Models:** 191 | **Resolved:** 186 (97.4%)
...
|------|-------|-------|------------|------|-----------|----------|-----------|---------|
| 1 | glm-5 | 1456 | 744 (40) | MoE | 1860 | 930 | 465 | Multi-GPU |
...
| 5 | kimi-k2.5-instant | 1432 | 1000 (32) | MoE | 2500 | 1250 | 625 | Multi-GPU |
...
| 9 | deepseek-v3.2 | 1424 | 685 (37) | MoE | 1712.5 | 856.2 | 428.1 | Multi-GPU |
| 10 | deepseek-v3.2-exp | 1423 | 685 (37) | MoE | 1712.5 | 856.2 | 428.1 | Multi-GPU |
...
| 14 | qwen3.5-122b-a10b | 1417 | 125 (10) | MoE | 312.5 | 156.2 | 78.1 | B200 SXM (FP8) |
| 15 | deepseek-v3.1 | 1417 | 685 (37) | MoE | 1712.5 | 856.2 | 428.1 | Multi-GPU |
...
| 19 | mistral-large-3 | 1416 | 675 (41) | MoE | 1687.5 | 843.8 | 421.9 | Multi-GPU |
| 20 | deepseek-v3.1-terminus-thinking | 1416 | 685 (37) | MoE | 1712.5 | 856.2 | 428.1 | Multi-GPU |
| 21 | deepseek-v3.1-terminus | 1415 | 685 (37) | MoE | 1712.5 | 856.2 | 428.1 | Multi-GPU |
...
| 24 | qwen3.5-27b | 1406 | 27.8 | Dense | 69.5 | 34.8 | 17.4 | H100 SXM (FP8) |
...
| 30 | qwen3.5-35b-a3b | 1398 | 36 (3) | MoE | 90 | 45 | 22.5 | H100 SXM (FP8) |
...
| 39 | qwen3-30b-a3b-instruct-2507 | 1382 | 30.5 (3.3) | MoE | 76.2 | 38.1 | 19.1 | H100 SXM (FP8) |
...
| 47 | minimax-m1 | 1364 | 456 (45.9) | MoE | 1140 | 570 | 285 | Multi-GPU |
...
| 50 | mistral-small-2506 | 1357 | 22 | Dense | 55 | 27.5 | 13.8 | H100 SXM (FP8) |
...
| 54 | glm-4.5v | 1352 | 108 (12) | MoE | 270 | 135 | 67.5 | H200 SXM (FP8) |
| 55 | step-3 | 1347 | ? | ? | ? | ? | ? | ? |
| 56 | minimax-m2 | 1347 | 230 (10) | MoE | 575 | 287.5 | 143.8 | B300 SXM (FP8) |
| 57 | qwen3-32b | 1346 | 32.8 | Dense | 82 | 41 | 20.5 | H100 SXM (FP8) |
| 58 | llama-3.1-nemotron-ultra-253b-v1 | 1346 | 253 | Dense | 632.5 | 316.2 | 158.1 | Multi-GPU |
...
| 69 | molmo-2-8b | 1325 | 8.7 | Dense | 21.8 | 10.9 | 5.4 | H100 SXM (FP8) |
...
| 73 | gemma-3n-e4b-it | 1318 | 8.4 (4) | MoE | 21 | 10.5 | 5.2 | H100 SXM (FP8) |
...
| 84 | mistral-small-3.1-24b-instruct-2503 | 1302 | 24 | Dense | 60 | 30 | 15 | H100 SXM (FP8) |
| 85 | gemma-3-4b-it | 1302 | 4.3 | Dense | 10.8 | 5.4 | 2.7 | H100 SXM (FP8) |
...
| 92 | olmo-3.1-32b-think | 1286 | 32.2 | Dense | 80.5 | 40.2 | 20.1 | H100 SXM (FP8) |
| 93 | llama-3.1-tulu-3-70b | 1286 | 70 | Dense | 175 | 87.5 | 43.8 | RTX PRO 6000 (FP8) |
