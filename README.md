...
> **Last updated:** 2026-03-04 06:40 UTC | **Models:** 190 | **Resolved:** 184 (96.8%)
...
| B200 SXM | 180 GB | qwen3.5-122b-a10b | #10 | 125B | MoE | 156.2 GB |
| B300 SXM | 288 GB | qwen3.5-122b-a10b | #10 | 125B | MoE | 156.2 GB |

### INT4 (4-bit)

| GPU | VRAM | Best Model | Arena Rank | Params | Arch | Serving VRAM |
|-----|------|------------|------------|--------|------|--------------|
| H100 SXM | 80 GB | qwen3.5-122b-a10b | #10 | 125B | MoE | 78.1 GB |
| RTX PRO 6000 | 96 GB | qwen3.5-122b-a10b | #10 | 125B | MoE | 78.1 GB |
| H200 SXM | 141 GB | qwen3.5-122b-a10b | #10 | 125B | MoE | 78.1 GB |
| B200 SXM | 180 GB | qwen3.5-122b-a10b | #10 | 125B | MoE | 78.1 GB |
...
|------|-------|-------|------------|------|-----------|----------|-----------|---------|
| 1 | glm-5 | 1454 | 744 (40) | MoE | 1860 | 930 | 465 | Multi-GPU |
...
| 10 | qwen3.5-122b-a10b | 1423 | 125 (10) | MoE | 312.5 | 156.2 | 78.1 | B200 SXM (FP8) |
| 11 | qwen3-235b-a22b-instruct-2507 | 1422 | 235 (22) | MoE | 587.5 | 293.8 | 146.9 | Multi-GPU |
| 12 | deepseek-v3.2 | 1420 | 685 (37) | MoE | 1712.5 | 856.2 | 428.1 | Multi-GPU |
...
| 22 | qwen3-vl-235b-a22b-instruct | 1414 | 235 (22) | MoE | 587.5 | 293.8 | 146.9 | Multi-GPU |
...
| 31 | qwen3-vl-235b-a22b-thinking | 1394 | 235 (22) | MoE | 587.5 | 293.8 | 146.9 | Multi-GPU |
| 32 | deepseek-v3-0324 | 1394 | 671 (37) | MoE | 1677.5 | 838.8 | 419.4 | Multi-GPU |
| 33 | qwen3.5-35b-a3b | 1393 | 36 (3) | MoE | 90 | 45 | 22.5 | H100 SXM (FP8) |
| 34 | mimo-v2-flash (non-thinking) | 1390 | 309 (15) | MoE | 772.5 | 386.2 | 193.1 | Multi-GPU |
| 35 | step-3.5-flash | 1387 | ? | ? | ? | ? | ? | ? |
...
| 49 | intellect-3 | 1356 | 107 | Dense | 267.5 | 133.8 | 66.9 | H200 SXM (FP8) |
| 50 | mistral-small-2506 | 1356 | 22 | Dense | 55 | 27.5 | 13.8 | H100 SXM (FP8) |

<details><summary>Show remaining 140 models</summary>

| Rank | Model | Score | Params (B) | Arch | VRAM BF16 | VRAM FP8 | VRAM INT4 | Fits on |
|------|-------|-------|------------|------|-----------|----------|-----------|---------|
| 51 | gpt-oss-120b | 1353 | 117 (5.1) | MoE | 292.5 | 146.2 | 73.1 | B200 SXM (FP8) |
| 52 | glm-4.5v | 1352 | 108 (12) | MoE | 270 | 135 | 67.5 | H200 SXM (FP8) |
| 53 | command-a-03-2025 | 1352 | 111 | Dense | 277.5 | 138.8 | 69.4 | H200 SXM (FP8) |
...
| 58 | step-3 | 1346 | ? | ? | ? | ? | ? | ? |
| 59 | gemma-3-12b-it | 1341 | 12.2 | Dense | 30.5 | 15.2 | 7.6 | H100 SXM (FP8) |
| 60 | nvidia-llama-3.3-nemotron-super-49b-v1.5 | 1341 | 49 | Dense | 122.5 | 61.2 | 30.6 | H100 SXM (FP8) |
| 61 | qwq-32b | 1335 | 32.8 | Dense | 82 | 41 | 20.5 | H100 SXM (FP8) |
| 62 | llama-3.1-405b-instruct-bf16 | 1334 | 405 | Dense | 1012.5 | 506.2 | 253.1 | Multi-GPU |
| 63 | llama-3.1-405b-instruct-fp8 | 1333 | 405 | Dense | 1012.5 | 506.2 | 253.1 | Multi-GPU |
| 64 | olmo-3.1-32b-instruct | 1330 | 32.2 | Dense | 80.5 | 40.2 | 20.1 | H100 SXM (FP8) |
| 65 | molmo-2-8b | 1328 | 8.7 | Dense | 21.8 | 10.9 | 5.4 | H100 SXM (FP8) |
| 66 | qwen3-30b-a3b | 1328 | 30.5 (3.3) | MoE | 76.2 | 38.1 | 19.1 | H100 SXM (FP8) |
| 67 | llama-4-maverick-17b-128e-instruct | 1327 | 400 (17) | MoE | 1000 | 500 | 250 | Multi-GPU |
| 68 | llama-3.3-nemotron-49b-super-v1 | 1327 | 49 | Dense | 122.5 | 61.2 | 30.6 | H100 SXM (FP8) |
| 69 | deepseek-v2.5-1210 | 1323 | 236 (21) | MoE | 590 | 295 | 147.5 | Multi-GPU |
| 70 | llama-4-scout-17b-16e-instruct | 1322 | 109 (17) | MoE | 272.5 | 136.2 | 68.1 | H200 SXM (FP8) |
| 71 | ring-flash-2.0 | 1320 | 103 (6.1) | MoE | 257.5 | 128.8 | 64.4 | H200 SXM (FP8) |
| 72 | gemma-3n-e4b-it | 1319 | 8.4 (4) | MoE | 21 | 10.5 | 5.2 | H100 SXM (FP8) |
...
| 80 | athene-70b-0725 | 1305 | 70 | Dense | 175 | 87.5 | 43.8 | RTX PRO 6000 (FP8) |
| 81 | olmo-3-32b-think | 1305 | 32.2 | Dense | 80.5 | 40.2 | 20.1 | H100 SXM (FP8) |
| 82 | mistral-large-2411 | 1304 | 123 | Dense | 307.5 | 153.8 | 76.9 | B200 SXM (FP8) |
| 83 | mistral-small-3.1-24b-instruct-2503 | 1304 | 24 | Dense | 60 | 30 | 15 | H100 SXM (FP8) |
| 84 | gemma-3-4b-it | 1303 | 4.3 | Dense | 10.8 | 5.4 | 2.7 | H100 SXM (FP8) |
| 85 | qwen2.5-72b-instruct | 1302 | 72 | Dense | 180 | 90 | 45 | RTX PRO 6000 (FP8) |
| 86 | llama-3.1-nemotron-70b-instruct | 1298 | 70 | Dense | 175 | 87.5 | 43.8 | RTX PRO 6000 (FP8) |
| 87 | llama-3.1-70b-instruct | 1293 | 70 | Dense | 175 | 87.5 | 43.8 | RTX PRO 6000 (FP8) |
| 88 | jamba-1.5-large | 1288 | 398 (94) | MoE | 995 | 497.5 | 248.8 | Multi-GPU |
| 89 | gemma-2-27b-it | 1287 | 27 | Dense | 67.5 | 33.8 | 16.9 | H100 SXM (FP8) |
...
| 97 | llama-3-70b-instruct | 1275 | 70 | Dense | 175 | 87.5 | 43.8 | RTX PRO 6000 (FP8) |
| 98 | mistral-small-24b-instruct-2501 | 1273 | 24 | Dense | 60 | 30 | 15 | H100 SXM (FP8) |
| 99 | qwen2.5-coder-32b-instruct | 1270 | 32 | Dense | 80 | 40 | 20 | H100 SXM (FP8) |
| 100 | c4ai-aya-expanse-32b | 1266 | 32 | Dense | 80 | 40 | 20 | H100 SXM (FP8) |
| 101 | gemma-2-9b-it | 1265 | 9 | Dense | 22.5 | 11.2 | 5.6 | H100 SXM (FP8) |
| 102 | deepseek-coder-v2 | 1263 | 236 (21) | MoE | 590 | 295 | 147.5 | Multi-GPU |
| 103 | command-r-plus | 1261 | 104 | Dense | 260 | 130 | 65 | H200 SXM (FP8) |
| 104 | qwen2-72b-instruct | 1261 | 72 | Dense | 180 | 90 | 45 | RTX PRO 6000 (FP8) |
| 105 | phi-4 | 1255 | 14 | Dense | 35 | 17.5 | 8.8 | H100 SXM (FP8) |
| 106 | olmo-2-0325-32b-instruct | 1251 | 32 | Dense | 80 | 40 | 20 | H100 SXM (FP8) |
| 107 | command-r-08-2024 | 1249 | 35 | Dense | 87.5 | 43.8 | 21.9 | H100 SXM (FP8) |
| 108 | jamba-1.5-mini | 1238 | 52 (12) | MoE | 130 | 65 | 32.5 | H100 SXM (FP8) |
| 109 | ministral-8b-2410 | 1236 | 8 | Dense | 20 | 10 | 5 | H100 SXM (FP8) |
| 110 | qwen1.5-110b-chat | 1233 | 110 | Dense | 275 | 137.5 | 68.8 | H200 SXM (FP8) |
| 111 | qwen1.5-72b-chat | 1232 | 72 | Dense | 180 | 90 | 45 | RTX PRO 6000 (FP8) |
| 112 | mixtral-8x22b-instruct-v0.1 | 1229 | 141 (39) | MoE | 352.5 | 176.2 | 88.1 | B200 SXM (FP8) |
| 113 | command-r | 1226 | 35 | Dense | 87.5 | 43.8 | 21.9 | H100 SXM (FP8) |
| 114 | llama-3-8b-instruct | 1222 | 8 | Dense | 20 | 10 | 5 | H100 SXM (FP8) |
| 115 | c4ai-aya-expanse-8b | 1222 | 8 | Dense | 20 | 10 | 5 | H100 SXM (FP8) |
| 116 | llama-3.1-tulu-3-8b | 1220 | 8 | Dense | 20 | 10 | 5 | H100 SXM (FP8) |
| 117 | yi-1.5-34b-chat | 1213 | 34 | Dense | 85 | 42.5 | 21.2 | H100 SXM (FP8) |
| 118 | zephyr-orpo-141b-A35b-v0.1 | 1212 | 141 (35) | MoE | 352.5 | 176.2 | 88.1 | B200 SXM (FP8) |
| 119 | llama-3.1-8b-instruct | 1211 | 8 | Dense | 20 | 10 | 5 | H100 SXM (FP8) |
| 120 | granite-3.1-8b-instruct | 1208 | 8 | Dense | 20 | 10 | 5 | H100 SXM (FP8) |
| 121 | qwen1.5-32b-chat | 1203 | 32 | Dense | 80 | 40 | 20 | H100 SXM (FP8) |
| 122 | gemma-2-2b-it | 1198 | 2 | Dense | 5 | 2.5 | 1.2 | H100 SXM (FP8) |
| 123 | phi-3-medium-4k-instruct | 1197 | 14 | Dense | 35 | 17.5 | 8.8 | H100 SXM (FP8) |
| 124 | mixtral-8x7b-instruct-v0.1 | 1196 | 46.7 (12.9) | MoE | 116.8 | 58.4 | 29.2 | H100 SXM (FP8) |
| 125 | dbrx-instruct-preview | 1194 | 132 (36) | MoE | 330 | 165 | 82.5 | B200 SXM (FP8) |
| 126 | internlm2_5-20b-chat | 1191 | 20 | Dense | 50 | 25 | 12.5 | H100 SXM (FP8) |
| 127 | qwen1.5-14b-chat | 1190 | 14 | Dense | 35 | 17.5 | 8.8 | H100 SXM (FP8) |
| 128 | wizardlm-70b | 1184 | 70 | Dense | 175 | 87.5 | 43.8 | RTX PRO 6000 (FP8) |
| 129 | deepseek-llm-67b-chat | 1184 | 67 | Dense | 167.5 | 83.8 | 41.9 | RTX PRO 6000 (FP8) |
| 130 | yi-34b-chat | 1183 | 34 | Dense | 85 | 42.5 | 21.2 | H100 SXM (FP8) |
...
| 138 | openhermes-2.5-mistral-7b | 1174 | 7 | Dense | 17.5 | 8.8 | 4.4 | H100 SXM (FP8) |
| 139 | vicuna-33b | 1172 | 33 | Dense | 82.5 | 41.2 | 20.6 | H100 SXM (FP8) |
| 140 | starling-lm-7b-beta | 1171 | 7 | Dense | 17.5 | 8.8 | 4.4 | H100 SXM (FP8) |
| 141 | phi-3-small-8k-instruct | 1170 | 7.4 | Dense | 18.5 | 9.2 | 4.6 | H100 SXM (FP8) |
| 142 | llama-2-70b-chat | 1170 | 70 | Dense | 175 | 87.5 | 43.8 | RTX PRO 6000 (FP8) |
| 143 | starling-lm-7b-alpha | 1167 | 7 | Dense | 17.5 | 8.8 | 4.4 | H100 SXM (FP8) |
| 144 | llama-3.2-3b-instruct | 1166 | 3 | Dense | 7.5 | 3.8 | 1.9 | H100 SXM (FP8) |
| 145 | nous-hermes-2-mixtral-8x7b-dpo | 1164 | 44.8 (12.6) | MoE | 112 | 56 | 28 | H100 SXM (FP8) |
| 146 | qwq-32b-preview | 1156 | 32.8 | Dense | 82 | 41 | 20.5 | H100 SXM (FP8) |
| 147 | granite-3.0-2b-instruct | 1155 | 2 | Dense | 5 | 2.5 | 1.2 | H100 SXM (FP8) |
| 148 | llama2-70b-steerlm-chat | 1155 | 70 | Dense | 175 | 87.5 | 43.8 | RTX PRO 6000 (FP8) |
| 149 | solar-10.7b-instruct-v1.0 | 1152 | 10.7 | Dense | 26.8 | 13.4 | 6.7 | H100 SXM (FP8) |
| 150 | dolphin-2.2.1-mistral-7b | 1151 | 7 | Dense | 17.5 | 8.8 | 4.4 | H100 SXM (FP8) |
| 151 | mpt-30b-chat | 1149 | 30 | Dense | 75 | 37.5 | 18.8 | H100 SXM (FP8) |
| 152 | mistral-7b-instruct-v0.2 | 1149 | 7 | Dense | 17.5 | 8.8 | 4.4 | H100 SXM (FP8) |
| 153 | wizardlm-13b | 1148 | 13 | Dense | 32.5 | 16.2 | 8.1 | H100 SXM (FP8) |
| 154 | falcon-180b-chat | 1146 | 180 | Dense | 450 | 225 | 112.5 | B300 SXM (FP8) |
| 155 | qwen1.5-7b-chat | 1143 | 7 | Dense | 17.5 | 8.8 | 4.4 | H100 SXM (FP8) |
| 156 | phi-3-mini-4k-instruct-june-2024 | 1142 | 3.8 | Dense | 9.5 | 4.8 | 2.4 | H100 SXM (FP8) |
| 157 | llama-2-13b-chat | 1141 | 13 | Dense | 32.5 | 16.2 | 8.1 | H100 SXM (FP8) |
| 158 | vicuna-13b | 1140 | 13 | Dense | 32.5 | 16.2 | 8.1 | H100 SXM (FP8) |
| 159 | qwen-14b-chat | 1138 | 14 | Dense | 35 | 17.5 | 8.8 | H100 SXM (FP8) |
| 160 | codellama-34b-instruct | 1136 | 34 | Dense | 85 | 42.5 | 21.2 | H100 SXM (FP8) |
| 161 | gemma-7b-it | 1135 | 7 | Dense | 17.5 | 8.8 | 4.4 | H100 SXM (FP8) |
| 162 | zephyr-7b-beta | 1130 | 7 | Dense | 17.5 | 8.8 | 4.4 | H100 SXM (FP8) |
| 163 | phi-3-mini-128k-instruct | 1128 | 3.8 | Dense | 9.5 | 4.8 | 2.4 | H100 SXM (FP8) |
| 164 | phi-3-mini-4k-instruct | 1128 | 3.8 | Dense | 9.5 | 4.8 | 2.4 | H100 SXM (FP8) |
| 165 | guanaco-33b | 1126 | 33 | Dense | 82.5 | 41.2 | 20.6 | H100 SXM (FP8) |
| 166 | zephyr-7b-alpha | 1126 | 7 | Dense | 17.5 | 8.8 | 4.4 | H100 SXM (FP8) |
...
| 174 | llama-2-7b-chat | 1107 | 7 | Dense | 17.5 | 8.8 | 4.4 | H100 SXM (FP8) |
| 175 | gemma-2b-it | 1091 | 2 | Dense | 5 | 2.5 | 1.2 | H100 SXM (FP8) |
...
| 183 | RWKV-4-Raven-14B | 1040 | 14 | Dense | 35 | 17.5 | 8.8 | H100 SXM (FP8) |
| 184 | chatglm2-6b | 1023 | 6 | Dense | 15 | 7.5 | 3.8 | H100 SXM (FP8) |
| 185 | oasst-pythia-12b | 1021 | 12 | Dense | 30 | 15 | 7.5 | H100 SXM (FP8) |
| 186 | chatglm-6b | 995 | 6 | Dense | 15 | 7.5 | 3.8 | H100 SXM (FP8) |
| 187 | fastchat-t5-3b | 990 | 3 | Dense | 7.5 | 3.8 | 1.9 | H100 SXM (FP8) |
| 188 | dolly-v2-12b | 979 | 12 | Dense | 30 | 15 | 7.5 | H100 SXM (FP8) |
| 189 | llama-13b | 971 | 13 | Dense | 32.5 | 16.2 | 8.1 | H100 SXM (FP8) |
| 190 | stablelm-tuned-alpha-7b | 952 | 7 | Dense | 17.5 | 8.8 | 4.4 | H100 SXM (FP8) |
